...
df = all_sens[all_sens['prm_file'] == 'cap_high'].copy()
...
fig.suptitle('Change in CO₂ Emissions - Fossil (Generation and Extraction) and Renewables (Generation)\nCapital/Energy Substitution Elasticity Increased 50%',
             fontsize=20, y=0.98)

plt.savefig('experiment_gen_and_commodity_cap_high_emissions.png', dpi=300, bbox_inches='tight')
