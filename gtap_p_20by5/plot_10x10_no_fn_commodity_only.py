...
df = pd.read_csv('results/experiment_10x10_no_fn_commodity_only_results.csv')
...
ax.set_title('Change in CO₂ Emissions - No Fuel-Neutral Adoption, Fossil Extraction Only\n(10×10 Grid, Each cell represents one simulation)')
...
plt.tight_layout()
plt.savefig('experiment_10x10_no_fn_commodity_only_emissions.png', dpi=300, bbox_inches='tight')
