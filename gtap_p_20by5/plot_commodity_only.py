...
df = pd.read_csv('results_final/experiment_commodity_only_results.csv')
...
fig.suptitle('Change in CO₂ Emissions - Fossil (Extraction) and Renewables (Generation)\n(4×4 Grid for each Fuel-Neutral Adoption Level)',
             fontsize=20, y=0.98)

plt.savefig('experiment_commodity_only_emissions.png', dpi=300, bbox_inches='tight')
