...
df = all_sens[all_sens['prm_file'] == 'type_low'].copy()
...
fig.suptitle('Change in CO₂ Emissions - Fossil (Generation and Extraction) and Renewables (Generation)\nPower Generation Type Substitution Elasticities Reduced 50%',
             fontsize=20, y=0.98)

plt.savefig('experiment_gen_and_commodity_type_low_emissions.png', dpi=300, bbox_inches='tight')
