...
df = pd.read_csv('results_final/experiment_gen_and_commodity_results_ctax_160.csv')
baseline_df = pd.read_csv('baseline_co2_ctax_160.csv')
...
plt.savefig('experiment_gen_and_commodity_ctax_160_emissions.png', dpi=300, bbox_inches='tight')
