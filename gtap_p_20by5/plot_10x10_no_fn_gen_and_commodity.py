...
df = pd.read_csv('results_final/experiment_10x10_no_fn_gen_and_commodity_results.csv')
...
ax.set_title('Change in CO₂ Emissions (Gt) -\nFossil (Generation and Extraction) and Renewables (Generation)', fontsize=22)
