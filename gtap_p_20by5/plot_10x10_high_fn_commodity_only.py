...
df = pd.read_csv('results/experiment_10x10_high_fn_commodity_only_results.csv')
...
ax.set_title('Change in CO₂ Emissions - High Fuel-Neutral Adoption, Fossil Extraction Only\n(10×10 Grid, Each cell represents one simulation)')
