...
df = pd.read_csv('results_final/experiment_10x10_high_fn_generation_only_results.csv')
...
plt.tight_layout()
plt.savefig('experiment_10x10_high_fn_generation_only_emissions.png', dpi=300, bbox_inches='tight')
