...
df = pd.read_csv('results_final/experiment_10x10_medium_fn_gen_and_commodity_results.csv')
...
ax.set_title('Change in CO₂ Emissions (Gt) -\nFossil (Generation and Extraction) and Renewables (Generation)\nMedium Fuel-Neutral Adoption', fontsize=22)
...
plt.tight_layout()
plt.savefig('experiment_10x10_medium_fn_gen_and_commodity_emissions.png', dpi=300, bbox_inches='tight')
