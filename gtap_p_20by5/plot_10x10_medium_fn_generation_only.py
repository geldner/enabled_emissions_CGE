...
df = pd.read_csv('results/experiment_10x10_medium_fn_generation_only_results.csv')
...
ax.set_title('Change in CO₂ Emissions - Medium Fuel-Neutral Adoption, Generation Only\n(10×10 Grid, Each cell represents one simulation)')
