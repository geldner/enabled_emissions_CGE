...
df = pd.read_csv('results/experiment_10x10_low_fn_gen_and_commodity_results.csv')
...
ax.set_title('Change in CO₂ Emissions - Low Fuel-Neutral Adoption, Generation and Fossil Extraction\n(10×10 Grid, Each cell represents one simulation)')
